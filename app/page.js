                                                                                                ...
                                                                                                <div style={{ display: "flex", flexDirection: "column", gap: "15px", maxWidth: 300, margin: "0 auto" }}>
                                                                                                          <GlowButton text="Sign in with Google" onClick={googleLogin} />
                                                                                                                    <GlowButton text="Sign in with Twitter" onClick={twitterLogin} />
                                                                                                                              ...
                                                                                                                              <input style={{ padding: "12px", borderRadius: "8px" }} placeholder="Email" onChange={(e) => setEmail(e.target.value)} />
                                                                                                                                        <input style={{ padding: "12px", borderRadius: "8px" }} type="password" placeholder="Password" onChange={(e) => setPassword(e.target.value)} />
